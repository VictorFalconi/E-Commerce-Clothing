    ...
    <div className={styles.side} id="light">  
      ...
      ? <div>
        ...
        <select value={azOrder} className={styles.buttonFilter} onChange={(e) => {dispatch({type: 'azOrder', payload: e.target.value})}}>
          ...
          <option  style={{ fontFamily: 'Raleway'}} value="AZ">Name A to Z</option>
          <option  style={{ fontFamily: 'Raleway'}} value="ZA">Name Z to A</option>
          <option  style={{ fontFamily: 'Raleway'}} value="HL">Price high to low</option>
          <option  style={{ fontFamily: 'Raleway'}} value="LH">Price low to high</option>
        </select>
        <label>Brand: </label>
        <select value={brandFilter} className={styles.buttonFilter} onChange={(e) => {dispatch({type: 'brandFilter', payload: e.target.value});}}>
